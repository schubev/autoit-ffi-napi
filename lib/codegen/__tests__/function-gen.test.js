...
export async function controlClick(windowDescription: WindowDescription, windowText: string, controlDescription: WindowDescription, button: MouseButton, numClicks: number, nX: number, nY: number): Promise<boolean> {
