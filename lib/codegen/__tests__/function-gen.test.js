...
describe(generateFunction, () => {
    it('creates the most basic function', () => {
        ...
        expect(generateFunction('AU3_FooBar', voidvoidfoo)).toEqual(`// This file is generated by src/codegen/function-gen.ts.
...
export async function fooBar(): Promise<void> {
  return new Promise(resolve => {
    ...
    it('creates a function with a single parameter', () => {
        ...
        expect(generateFunction('AU3_FooBar', voidintfoo)).toEqual(`// This file is generated by src/codegen/function-gen.ts.
import { lib } from '../../lowlevel'
...
export async function fooBar(qux: number, baz: number): Promise<void> {
  return new Promise(resolve => {
    ...
    it('generates the AU3_error function', () => {
        ...
        expect(generateFunction(name, functionDef)).toEqual(`// This file is generated by src/codegen/function-gen.ts.
import { lib } from '../../lowlevel'
...
export async function controlClick(windowDescription: string | WindowDescription, windowText: string, controlDescription: string | WindowDescription, button: MouseButton, numClicks: number, nX: number, nY: number): Promise<boolean> {
  ...
  return new Promise(resolve => {
    lib.AU3_ControlClick.async(windowDescriptionBuffer, windowTextBuffer, controlDescriptionBuffer, buttonBuffer, numClicks, nX, nY, (status: 0 | 1) => { resolve(status === 1) })
  })
}`);
    });
...
export async function winGetTitle(windowDescription: string | WindowDescription, windowText: string, titleSize = 512): Promise<string> {
  const windowDescriptionBuffer = inWstrOfWindowDescription(windowDescription)
  const windowTextBuffer = inWstrOfString(windowText)
