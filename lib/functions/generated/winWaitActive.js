...
async function winWaitActive(windowDescription, windowText, timeoutSeconds = 0, library) {
    ...
    const result = await lib.AU3_WinWaitActive(windowDescriptionBuffer, windowTextBuffer, timeoutSeconds);
    return result !== 0;
}
