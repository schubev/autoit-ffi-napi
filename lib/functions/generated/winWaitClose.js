...
async function winWaitClose(windowDescription, windowText, timeoutSeconds = 0, library) {
    ...
    const result = await lib.AU3_WinWaitClose(windowDescriptionBuffer, windowTextBuffer, timeoutSeconds);
    return result !== 0;
}
