...
const AU3_WinWaitClose = util_1.promisify(lowlevel_1.lib.AU3_WinWaitClose.async);
async function winWaitClose(windowDescription, windowText, timeoutSeconds = 0) {
