...
async function winSetTrans(windowDescription, windowText, transparency, library) {
    ...
    const result = await lib.AU3_WinSetTrans(windowDescriptionBuffer, windowTextBuffer, transparency);
    return result !== 0;
}
