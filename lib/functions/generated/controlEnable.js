...
async function controlEnable(windowDescription, windowText, controlDescription, library) {
    ...
    const result = await lib.AU3_ControlEnable(windowDescriptionBuffer, windowTextBuffer, controlDescriptionBuffer);
    return result !== 0;
}
