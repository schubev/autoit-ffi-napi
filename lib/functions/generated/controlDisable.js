...
async function controlDisable(windowDescription, windowText, controlDescription, library) {
    ...
    const result = await lib.AU3_ControlDisable(windowDescriptionBuffer, windowTextBuffer, controlDescriptionBuffer);
    return result !== 0;
}
