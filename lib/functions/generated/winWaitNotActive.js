...
async function winWaitNotActive(windowDescription, windowText, timeoutSeconds = 0, library) {
    ...
    const result = await lib.AU3_WinWaitNotActive(windowDescriptionBuffer, windowTextBuffer, timeoutSeconds);
    return result !== 0;
}
