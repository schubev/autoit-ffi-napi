...
async function controlFocus(windowDescription, windowText, controlDescription, library) {
    ...
    const result = await lib.AU3_ControlFocus(windowDescriptionBuffer, windowTextBuffer, controlDescriptionBuffer);
    return result !== 0;
}
