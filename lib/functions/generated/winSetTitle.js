...
async function winSetTitle(windowDescription, windowText, title, library) {
    ...
    const result = await lib.AU3_WinSetTitle(windowDescriptionBuffer, windowTextBuffer, titleBuffer);
    return result !== 0;
}
