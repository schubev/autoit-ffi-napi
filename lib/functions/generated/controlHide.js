...
async function controlHide(windowDescription, windowText, controlDescription, library) {
    ...
    return lib.AU3_ControlHide(windowDescriptionBuffer, windowTextBuffer, controlDescriptionBuffer);
}
