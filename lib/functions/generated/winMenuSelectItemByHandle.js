...
async function winMenuSelectItemByHandle(window, item0 = '', item1 = '', item2 = '', item3 = '', item4 = '', item5 = '', item6 = '', item7 = '', library) {
    ...
    const result = await lib.AU3_WinMenuSelectItemByHandle(window.toNumber(), item0Buffer, item1Buffer, item2Buffer, item3Buffer, item4Buffer, item5Buffer, item6Buffer, item7Buffer);
    return result !== 0;
}
