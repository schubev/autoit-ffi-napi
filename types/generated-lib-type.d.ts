...
export interface AutoitLib {
    ...
    AU3_WinSetState: {
        async(windowDescription: Buffer, windowText: Buffer, state: number, callback: (error: any, result: number) => void): void;
    };
    ...
    AU3_WinSetTrans: {
        async(windowDescription: Buffer, windowText: Buffer, transparency: number, callback: (error: any, result: number) => void): void;
    };
    AU3_WinSetTransByHandle: {
        async(window: number, transparency: number, callback: (error: any, result: number) => void): void;
    };
    AU3_WinWait: {
...
export interface PromisifiedAutoitLib {
    ...
    AU3_WinGetProcess(windowDescription: Buffer, windowText: Buffer): Promise<number>;
    AU3_WinGetProcessByHandle(window: number): Promise<number>;
    AU3_WinGetState(windowDescription: Buffer, windowText: Buffer): Promise<number>;
    ...
    AU3_WinSetTrans(windowDescription: Buffer, windowText: Buffer, transparency: number): Promise<number>;
